var productList = [
  ...
  var clothingCard = document.getElementById("clothingCard")
  var accessoriesCard = document.getElementById("accessoriesCard")


  var heading1 = document.createElement("h2")
  heading1.className = "heading"
  heading1.innerHTML = "Clothing for Men and Women"
  clothingCard.appendChild(heading1)


  var heading2 = document.createElement("h2")
  heading2.className = "heading"
  heading2.innerHTML = "Accessories for Men and Women"
  accessoriesCard.appendChild(heading2)


  var ccard = document.createElement("div")
  ccard.className = "cardContainer"
  ccard.id = "ccard"
  clothingCard.appendChild(ccard)


  var acard = document.createElement("div")
  acard.className = "cardContainer"
  acard.id = "acard"
  accessoriesCard.appendChild(acard)
...
for (var i = 0 ; i <= productList.length ; i++ ){
    if ( productList[i].isAccessory === false){
        ...
        cardDivision.className = "card"
        cardDivision.id = productList[i].id

        var imageContainer = document.createElement("div")
        imageContainer.className = "productImagecon"
        ...
        itemHeading.innerHTML = productList[i].name
        ...
        itemPrice.innerHTML = "Rs" + " " + productList[i].price

        clothingCard.appendChild(ccard)
        itemDetails.appendChild(itemHeading)
        itemDetails.appendChild(brandName)
        itemDetails.appendChild(itemPrice)
        cardDivision.appendChild(imageContainer)
        cardDivision.appendChild(itemDetails)
        ccard.appendChild(cardDivision)
    } else{
        var cardDivision = document.createElement("div")
        cardDivision.className = "card"
        cardDivision.id = productList[i].id
        ...
        cardDivision.appendChild(imageContainer)
        cardDivision.appendChild(itemDetails)
        acard.appendChild(cardDivision)
